...
# setting SOPC_SYSID_BASE_ADDRESS is 0x80011b0
SOPC_SYSID_FLAG += --sidp=0x80011b0
ELF_PATCH_FLAG  += --sidp 0x80011b0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1682971906
SOPC_SYSID_FLAG += --timestamp=1682971906
ELF_PATCH_FLAG  += --timestamp 1682971906
